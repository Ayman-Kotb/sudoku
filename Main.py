"""
Sudoku Solver with GUI - Main Application
CSP Implementation with Arc Consistency
Alexandria University - AI Course Assignment 3
"""
...
class SudokuGUI:
    ...
    def create_board(self, parent):
        ...
        self.score_label = tk.Label(info_frame, text="0",
                                   font=('Arial', 22, 'bold'), bg='#f0f0f0', fg='#4A90E2')
    ...
    def on_key_press(self, event, row, col):
        """Handle key press in interactive mode"""
        # Allow keyboard input in all modes for easier data entry
